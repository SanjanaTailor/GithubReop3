    ...
    OAuth.prototype = {
        ...
        init: function (options) {
            ...
            this.request = function (options) {
                ...
                // Added option for asynchronous transmission
                ...
                xhr = Request();
                // Error used to determine that the App is not connected

                xhr.onerror = function()
                {
                  var responseObject = {status:xhr.status, text: xhr.responseText,  detail: xhr.responseText};
                  xhr.onerror = null;
                  xhr.onreadystatechange = null;
                  return failure(responseObject);
                }
                ...
                xhr.onreadystatechange = function () {
                    if (xhr.readyState == 4) {
                        ...
                        // Added "status" return for error processing
                        var responseObject = {status:xhr.status, text: xhr.responseText, xml: (includeXML ? xhr.responseXML : ''), requestHeaders: requestHeaders, responseHeaders: responseHeaders};
                        ...
                        if((xhr.status >= 200 && xhr.status <= 226) || xhr.status == 304) {
                          ...
                          //xhr.removeAttribute("onreadystatechange");
                          xhr.onreadystatechange = null;
                          xhr.onerror = null;
                          return failure(responseObject);
                        }
                ...
                // Added variable asynchronous status
